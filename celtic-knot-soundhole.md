...
This is a **cut-out**. The removed material is the open area; the knot ribbon
...
OUT=knot.svg node celtic-knot-soundhole.js          # default 30mm design
...
- `celtic-knot-soundhole-r30.svg` — 10 crossings (N=5, default)
- `celtic-knot-soundhole-r30-8x.svg` — 8 crossings (N=4)
